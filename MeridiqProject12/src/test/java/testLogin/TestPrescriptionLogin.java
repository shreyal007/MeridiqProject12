...
public class TestPrescriptionLogin 
{
	...
	void login() throws InterruptedException
	{
		  ...
		  driver.get("https://early-access.meridiq.com/prescription/login");
		  Thread.sleep(5000);
		  ...
		  driver.findElement(By.xpath("//input[@type='email']")).sendKeys("sxttb70z@spymail.one");
		  Thread.sleep(3000);
